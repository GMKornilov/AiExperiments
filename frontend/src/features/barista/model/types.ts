...
export type ValidationResult = { status: "not_validated" | "passed"; summary?: string; legacy_unvalidated?: boolean };
export type Task = { id: string; title: string; description: string; stage: TaskStage; current_step: string; expected_action: string; status: TaskStatus; plan: TaskPlanItem[]; current_plan_item?: string; validation_result: ValidationResult; created_at: string; updated_at: string };
