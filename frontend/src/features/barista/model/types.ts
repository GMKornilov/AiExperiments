...
export type Dialog = { compression?: CompressionState; id: string; title: string; title_status: TitleStatus; created_at: string; updated_at: string; messages: BaristaMessage[]; accounted_tokens: number };
...
export type AdminLog = { call_id?: string; purpose?: "chat" | "title" | "summary"; payload?: string; http_status?: number; truncated?: boolean; attempt_id?: string; usage?: TokenUsage; timestamp: string; source: "frontend" | "backend"; event: string; result: string; correlation_id: string; dialog_id?: string; message_id?: string; duration_ms?: number; error_category?: string; text?: string };
