import { deleteDialog, getDialog, setCompression } from "@/lib/server/barista";
...
export async function PATCH(request: Request, { params }: Context) { return setCompression(request, (await params).id); }
